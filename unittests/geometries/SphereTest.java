...
class SphereTest {
    ...
    void testFindIntersections() {
        ...
        // TC11: Ray starts at sphere and goes inside (1 points)
         final  var result3 = sphere.findIntsersections(new Ray(new Point(0, 0, 0), new Vector(1, 1, 0)));
        ...
        final var result4 = sphere.findIntsersections(new Ray(p01, new Vector(1, 0, 0)));
        ...
        assertNull(sphere.findIntsersections(new Ray(gp1, v310.scale(-1))), "Ray starts at sphere and goes outside");
