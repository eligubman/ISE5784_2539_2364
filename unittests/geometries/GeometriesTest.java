...
class GeometriesTest {
    ...
    void testFindIntersections(){
        ...
        Geomet.add(new Cylinder(new Ray(new Point(1,1,1),new Vector(1,1,1)),1,2));
        ...
        assertEquals(6,Geomet.findIntersections(new Ray(new Point(0,0,0),new Vector(1,1,1))).size(),"more then one intsersections");
        ...
        assertEquals(8,Geomet.findIntersections(new Ray(new Point(-2,-2,-2),new Vector(1,1,1))).size(),"all intsersections");
