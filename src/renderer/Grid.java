...
public class Grid {
    ...
    public double cutsGrid(Ray ray) {
        ...
        return ray.getHead().distance(entry);
    }
    ...
    public List<GeoPoint> traverse(Ray i_currentRay, boolean multipleIntersection) {
        Ray currentRay = new Ray(gridEntryPoint(i_currentRay), i_currentRay.getDirection());
        List<GeoPoint> intersections = new ArrayList<>();
        Vector dir = currentRay.getDirection();
